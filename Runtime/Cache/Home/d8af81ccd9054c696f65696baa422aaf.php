                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" multiple style="width: 100%;"
                                            ...
                                            <?php if(is_array($rule)): foreach($rule as $k=>$v): ?><option value="<?php echo ($v["id"]); ?>" ><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </td>
...
<script>
    ...
    $(document).ready( function () {
        ...
        table_role = $('#table_role').DataTable({
            "ajax": {
                "url": "/office/index.php/Home/Teacher/auth.html?type=group_data",
