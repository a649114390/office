...
<head>
    ...
    <style type="text/css">
        ...
        *{margin:0;padding:0}
        ...
        .login-box{width:410px;margin:120px auto 0 auto;text-align:center;padding:30px;background:url(<?php echo (C("DIST_URL")); ?>/img/mask.png);border-radius:10px;}
...
<div class="login-box">
    <h1>后台登录</h1>
    <form method="post" action="/office/index.php/Home/Index/index.html" >
        <div class="name">
            <label>管理员账号：</label>
            <input type="text" name="user_id" id="" tabindex="1" >
        </div>
        <div class="password">
            <label>密  码：</label>
            <input type="password" name="user_pwd" maxlength="16" id="" tabindex="2">
        </div>
        <div class="code">
            <label>验证码：</label>
            <input type="text" name="code" maxlength="4" id="code" tabindex="3">
            <div class="codeImg">
                <img src="<?php echo U('Index/verify');?>" alt="看不清，换一张" onclick="this.src='<?php echo U('Index/verify');?>'" + Math.random() />
            </div>
        </div>
        <div class="remember">
...
<div class="bottom">©2014 Leting <a href="javascript:;" target="_blank">关于</a> <span>京ICP证030173号</span><img width="13" height="16" src="<?php echo (C("DIST_URL")); ?>/img/copy_rignt_24.png"></div>

<div class="screenbg">
    <ul>
        <li style="opacity: 0; visibility: visible;"><a href="javascript:;"><img src="<?php echo (C("DIST_URL")); ?>/img/0.jpg" style="width: 1905px;"></a></li>
        <li style="opacity: 0; visibility: visible;"><a href="javascript:;"><img src="<?php echo (C("DIST_URL")); ?>/img/1.jpg" style="width: 1905px;"></a></li>
        <li style="opacity: 1; visibility: visible;"><a href="javascript:;"><img src="<?php echo (C("DIST_URL")); ?>/img/2.jpg" style="width: 1905px;"></a></li>
    </ul>
</div>
