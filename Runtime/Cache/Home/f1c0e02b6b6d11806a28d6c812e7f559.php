...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        table = $('#table').DataTable({
            "ajax": {
                "url": "/office/index.php/Home/Mail/index.html?type=data",
            ...
            "columns": [
                ...
                {"data": "mail_title", "title": "主题",  "defaultContent": "","mRender":function (data,type,full) {
                    var url = "/office/index.php/Home/Mail/mailInfo.html";
                    if (full.mail_flag == 0){
    ...
    function deleteAll() {
        ...
        if (data == "") {
            ...
            swal({
                ...
                function(){
                    $.ajax({
                        url: "/office/index.php/Home/Mail/index.html?type=delete",
                        type: 'post',
                        dataType: 'text',
                        data: {'data': data}
                    })
