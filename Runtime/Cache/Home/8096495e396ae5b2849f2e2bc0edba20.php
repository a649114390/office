...
<ul class="timeline">
    ...
    <!-- timeline time label -->
    <li class="time-label">
        <span class="bg-blue" title="发布时间">

          <?php echo date('Y-m-d',$declare_info['add_time']); ?>
        </span>
    </li>
    <!-- /.timeline-label -->
    ...
    <li>
        ...
        <div class="timeline-item">
            <span class="time" title="详细时间"><i class="fa fa-clock-o"></i><?php echo date('Y-m-d H:i:s',$declare_info['add_time']); ?></span>

            <h3 class="timeline-header" title="标题"><?php echo ($declare_info['declare_title']); ?></h3>
            <div class="timeline-body">
              <?php echo ($declare_info['declare_content']); ?>
            </div>
        </div>
    </li>
    <?php if(($declare_info['declare_state']) != "-1"): $__FOR_START_11148321__=1;$__FOR_END_11148321__=$declare_info['declare_state']+1;for($i=$__FOR_START_11148321__;$i < $__FOR_END_11148321__;$i+=1){ ?><li class="time-label">
            <span class="bg-blue" title="审批时间"><?php echo date('Y-m-d',$declare_info[$i.'_time']); ?>
            </span>
            </li>
            <li>
                <i class="fa fa-user bg-aqua"></i>
                <div class="timeline-item">
                    <span class="time"><i class="fa fa-clock-o"></i><?php echo date('Y-m-d H:i:s',$declare_info[$i.'_time']); ?></span>

                    <h3 class="timeline-header no-border">教工号为<?php echo $declare_info[$i.'_check']; ?>的负责人,同意了你的申请</h3>
                </div>
            </li><?php } ?>
    <?php else: ?>
        <?php $__FOR_START_1422928125__=1;$__FOR_END_1422928125__=$declare_info['declare_fail_reason'][0]+1;for($i=$__FOR_START_1422928125__;$i < $__FOR_END_1422928125__;$i+=1){ if(($i) == $declare_info['declare_fail_reason'][0]): ?><li class="time-label">
                <span class="bg-red" title="审批时间"><?php echo date('Y-m-d',$declare_info[$i.'_time']); ?></span>
                </li>
                <li>
                    <i class="fa fa-user bg-aqua"></i>
                    <div class="timeline-item">
                        <span class="time"><i class="fa fa-clock-o"></i><?php echo date('Y-m-d H:i:s',$declare_info['declare_fail_reason'][2]); ?></span>
                        <h3 class="timeline-header no-border">教工号为<?php echo ($declare_info['declare_fail_reason'][1]); ?>的负责人,驳回了你的申请</h3>
                        <div class="timeline-body">
                            <?php echo ($declare_info['declare_fail_reason'][3]); ?>
                        </div>
                    </div>
                </li>
            <?php else: ?>
                ...
                <li class="time-label">
                    <span class="bg-blue" title="审批时间"><?php echo date('Y-m-d',$declare_info[$i.'_time']); ?></span>
                </li>
                <li>
                    <i class="fa fa-user bg-aqua"></i>
                    <div class="timeline-item">
