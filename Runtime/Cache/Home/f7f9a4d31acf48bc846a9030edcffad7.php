...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        table = $('#table').DataTable({
            "ajax": {
                "url": "/office/index.php/Home/Declare/info.html?type=data",
        ...
        $("#table tbody").on("click","#info",function(){
            ...
            var data=row.data();
            var id = data['id'];
            window.open("<?php echo U('Declare/timeLine');?>?id="+id);
        });
        ...
        $("#table tbody").on("click","#check",function(){
            ...
            var data=row.data();
            var id = data['id'];
            if ("<?php echo ($register_flag); ?>" == true){
                swal({
                        title: "登记",
                        text: "根据规定，您必须输入登记编号",
                        type: "input",
                    ...
                    function (inputValue) {
                        ...
                        $.ajax({
                            url:"/office/index.php/Home/Declare/info.html?type=check",
                            type:"post",
                            dataType:"json",
        ...
        $("#table tbody").on("click","#fail",function() {
            ...
            swal({
                ...
                function (inputValue) {
                    ...
                    reason = inputValue;
                    $.ajax({
                        url:"/office/index.php/Home/Declare/info.html?type=fail",
                        type:"post",
                        dataType:"text",
