...
<head>
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo (C("DIST_URL")); ?>/js/app.js"></script>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="<?php echo U('Student/stu_info');?>"><i class="fa fa-user"></i> <span>我要报销</span></a></li>
                <li><a href="<?php echo U('Student/stu_info');?>"><i class="fa fa-user"></i> <span>我的报销</span></a></li>
                <li><a href="<?php echo U('Mail/index');?>"><i class="fa fa-envelope-o"></i> <span>站内信</span></a></li>

                <li class="treeview">
                    <a href="<?php echo U('Ques/all_ques');?>"><i class="fa fa-link"></i> <span>站内消息</span>
                        <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="<?php echo U('Ques/ques_single');?>"><i class="fa fa-building-o"></i>发送站内信</a></li>
                        <li><a href="<?php echo U('Ques/ques_file');?>"><i class="fa fa-building-o"></i>管理站内信</a></li>
                    </ul>
                </li>
    ...
    <div class="box-header with-border">
        ...
        <div class="box-body">
                ...
                <p class="text-blank"><?php echo ($info["mail_title"]); ?></p>
                <p class="text-blank">发件人：<?php echo ($info['teacher_name']); ?></p>
                <p class="text-blank">时间：<?php echo date('Y-m-d H:i:s',$info['mail_add_time'])?></p>
            <div id="myEditor" style="height: 300px;" name="content">
                <?php echo ($info['mail_content']); ?>
            </div>
